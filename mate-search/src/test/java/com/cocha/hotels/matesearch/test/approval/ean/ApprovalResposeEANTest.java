...
public class ApprovalResposeEANTest {
    ...
    public void approvalTest() throws Exception {
        ...
        final InputStream resource = getClass().getClassLoader().getResourceAsStream(
                "respuestamocks/ResponseHotelSupplierEANEjemplo.json");
        final InputStream jsonHomologadoInputStream = getClass().getClassLoader().getResourceAsStream(
                "respuestamocks/ResponseHotelSupplierEANHomologada.json");

        // final InputStream resource =
        // getClass().getClassLoader().getResourceAsStream("respuestamocks/sin.json");
        // final InputStream jsonHomologadoInputStream =
        // getClass().getClassLoader().getResourceAsStream("respuestamocks/con.json");
